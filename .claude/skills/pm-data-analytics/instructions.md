...
description: SQL queries, data analysis, cohort analysis, funnel analysis, reporting, dashboard specs, data quality checks, anomaly detection. Use when writing SQL, analyzing data, building reports, creating dashboards, or investigating data issues.
---
...
For deeper data analysis methodology, load on demand:
- **Data analysis patterns**: `knowledge/pm-course/course-materials/lesson-modules/2.2-analyze-data/`

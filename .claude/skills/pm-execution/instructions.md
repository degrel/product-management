---
name: pm-execution
description: Feature specifications, acceptance criteria (Gherkin), user stories, edge cases, test cases, engineering handoff, API contracts, rollout plans. Use when writing specs, defining acceptance criteria, preparing engineering handoff, or generating test cases.
---
...
Scenario: Search returns no results
  ...
  And user sees message "Aucun resultat pour [term]"
